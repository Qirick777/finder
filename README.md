...
- [~] **Phase 4 — 사회 (거처·짝짓기·번식·이주)**
  ...
  - [x] **짝짓기 배회·구애**: 배회 시간대에 돌아다니다 이성 방랑자와 만나 잠시 마주보고 구애 →
        성립/거절/컷. 거절당하면 눈을 낮추고 그 상대는 잠시 피해 **딴 짝을 찾아 다시 배회**
        (양쪽이 각자 눈낮춤 → 교착 없음). 노동/밤엔 구애 안 함(§16)
...
- [x] **하루 사이클 통합 (식량 루프 in-world)**
  ...
  - [x] **슬라임 사냥**: 용감/사냥꾼/도축업자/무모 발현자만 슬라임을 사냥감으로 인식 → 가장 작은
        슬라임(크기1) 처치 시 동물과 같은 양의 식량. 미믹이 죽인 동물·몹은 **아이템 드랍 없음**

...
public final class Elder {
    ...
    /** 청년(성년) 기간(일). 9→11(성장 시계 SimTime 정합 P2의 실효 보존: 종전 실틱 기준
     *  성년 9일의 실효가 ~15 시뮬일이었음 — 정합화로 명목=실효가 되면서 왕조 1세대 완성
     *  창(3호 d9~10 < 노년 d11)을 유지하는 최소 명목치). 수명 2+11+3=16. */
    public static final int ADULT_DAYS = 11;

...
public final class FoodEconomy {
     ...
     *
     * <p><b>결론: 아이 소모는 손잡이로 쓸 수 없다. 1.5(원래 값)로 되돌린다.</b>
     *
     * <p>1.8 로 낮춰 재시도했더니 <b>엘리트가 6일째 밭을 못 세웠다</b>(앞선 모든 런은 d1 착공):
     * <pre>
     *   [d0 밤] 개간보류 저장고 15 &lt; 문턱 30 (착공 12 + 예비 18 — 가구 하루소모 8.5)
     *   [d3 밤] 개간보류 저장고 17 &lt; 문턱 30                        소모 10.6
     *   [d5 밤] 개간보류 저장고 19 &lt; 문턱 30                        소모  9.3
     * </pre>
     * "아이 소모는 출산선만 건드리고 개간은 안 건드린다"고 본 것이 틀렸다. <b>개간 예비도
     * 가구 하루소모 비례</b>다({@code FarmEconomy.foundReserve}). 그래서 아이 소모를 올리면
     * 가구 소모가 오르고 → <b>착공 문턱도 같이 올라</b> 저축이 영원히 따라잡지 못한다.
     * 여기에 집 유지비가 매일 깎으니 저장고가 15~19 에서 평탄해진다.
     *
     * <p>밭이 없으면 소작·지대·마름·막사·경비대가 전부 없다. 마을이 통째로 안 굴러간다.
     * 잉여를 걷는 일은 <b>출산선도 개간 문턱도 안 건드리는</b> 집 유지비가 맡는다.
     *

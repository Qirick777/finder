...
public final class Multipliers {
    ...
    /**
     * 정원(옆 베리) 수확 배율 M(g) = 1 + 0.42×(g/5)³ — 관리 능력 최고 등급 기준(무능력 g=0 → 1.0).
     * <b>성중립·채집특성 무관</b>: 성별 곱(±3배 분산)이 밴드 간격을 압도해 정원에서는 제거.
     * 여성당 2.4 재역산(b=0.50 기준): Ⅲ→4명 경계(2.33)·Ⅳ→5명(2.96≥2.82) 동시 충족
     * m = 0.42. Ⅰ 1.003 / Ⅱ 1.027 / Ⅲ 1.091 / Ⅳ 1.215 / Ⅴ 1.42.
     */
    public static double gardenAbility(Individual ind) {
        double r = manageAbilityGrade(ind) / 5.0;
        return 1.0 + 0.42 * r * r * r;
    }

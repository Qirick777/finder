...
public final class Multipliers {
    ...
    /**
     * 정원(옆 베리) 수확 배율 M(g) = 1 + 0.62×(g/5)³ — 관리 능력 최고 등급 기준(무능력 g=0 → 1.0).
     * <b>성중립·채집특성 무관</b>: 성별 곱(±3배 분산)이 밴드 간격을 압도해 정원에서는 제거.
     * 세대 압축(성년기 13일) 재역산: Ⅳ가 5명 경계(잉여 2.567+5%)에 닿도록
     * m = (M(Ⅳ)−1)/0.8³ = 0.315/0.512 ≈ 0.62.
     * Ⅰ 1.005 / Ⅱ 1.040 / Ⅲ 1.134 / Ⅳ 1.317 / Ⅴ 1.62.
     */
    public static double gardenAbility(Individual ind) {
        double r = manageAbilityGrade(ind) / 5.0;
        return 1.0 + 0.62 * r * r * r;
    }

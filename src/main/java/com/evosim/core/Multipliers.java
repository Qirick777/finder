...
public final class Multipliers {
    ...
    /**
     * 정원(옆 베리) 수확 배율 M(g) = 1 + 1.0×(g/5)³ — 관리 능력 최고 등급 기준(무능력 g=0 → 1.0).
     * 0.42→1.0(계층 분화 v2): 능력Ⅴ 정원 = 25회×0.20×2.0 = 10/일 — 엘리트 가구만 정원 자급+저축
     * (평민 5.0/일 = 완만한 적자). 계층 분화의 소득 격차 축.
     * <b>성중립·채집특성 무관</b>: 성별 곱(±3배 분산)이 밴드 간격을 압도해 정원에서는 제거.
     * m = 1.0. Ⅰ 1.008 / Ⅱ 1.064 / Ⅲ 1.216 / Ⅳ 1.512 / Ⅴ 2.0.
     */

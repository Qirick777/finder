...
public final class Multipliers {
    ...
    /**
     * 정원(옆 베리) 수확 배율 M(g) = 1 + 1.6×(g/5)³ — 관리 능력 최고 등급 기준(무능력 g=0 → 1.0).
     * 1.0→1.6(관측 런1 실측 보정): 엘리트 정원 13/일 — 첫 출산(가족 소모 6→7.9)과 얇은 러시
     * 채집이 저축을 잠식해 개간(30)이 d7로 밀리던 실측을 d2~3 창으로 복원(+3/일 역산).
     * 평민(r=0) 5.0/일 불변 — 계층 분화의 소득 격차 축.
     * <b>성중립·채집특성 무관</b>: 성별 곱(±3배 분산)이 밴드 간격을 압도해 정원에서는 제거.
     * m = 1.6. Ⅰ 1.013 / Ⅱ 1.102 / Ⅲ 1.346 / Ⅳ 1.819 / Ⅴ 2.6.
     */

...
public final class Polygyny {
     ...
     *  3→5(런8b 실측: 문턱 21이 개간 임계 33~39보다 낮아 엘리트가 착공 전 중혼으로 자금·소모를
     *  키워 착공이 d7+로 붕괴). D>2+18/소모(소모 6~10에서 4.6~3.8) → 5: 어떤 가구 규모든
     *  중혼 문턱 > 개간 임계 — "동기 있는 자는 밭 먼저, 중혼은 그 뒤"의 보편 산술. */
    public static final double SUPPORT_DAYS = 5.0;

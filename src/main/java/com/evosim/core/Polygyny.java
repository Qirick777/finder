...
public final class Polygyny {
     ...
     *  3→5→6: 5는 빈둥지 부부(소모 6)에서 중혼 문턱 30 = 개간 임계 18+2×6 = 30 <b>동률</b> —
     *  착공 자격 도달 순간 중혼이 허용돼 가구소모가 6→15로 뛰고 임계가 48로 도주(런13 실측:
     *  엘리트 저축 41 < 48, 착공 창 d3~5 붕괴). 6이면 6n > 18+2n ⟺ n > 4.5 — 최소 가구를
     *  포함한 전 규모에서 중혼 문턱 > 개간 임계 엄격 성립: "밭이 먼저, 중혼은 그 뒤". */
    public static final double SUPPORT_DAYS = 6.0;

...
public final class HomeTemplate {
    ...
    public enum Tier {
        SMALL(4, 0.0, 1.2, "small1", "small2", "small3"),
        MIDDLE(6, 12.0, 2.3, "middle1", "middle2"),
        BIG(9, 30.0, 3.8, "big1", "big2"),
        ...
        MANSION(12, 70.0, 6.5, "mansion", "mansion2");
         ...
         * 소득 구조 때문에 누진으로 작동한다.
         *
         * <p><b>1.5 는 과했다 → 1.2/2.3/3.8/6.5 로 후퇴</b>(3차). 2차(1.5) 실측 d5:
         * <pre>
         *   1인당 4.3 → 3.6 · 무토지 9.5 → 8.1 · 소작 8.5 → 6.0   (잉여는 노린 대로)
         *   그러나 인구 41 → <b>38 정체</b> · 미성년/성인여 0.69 → <b>0.57</b>
         *   지주 55.6 → <b>31.8</b> · 개간 타일 36 → 31 (지주가 마르면 막사·시설이 늦는다)
         * </pre>
         * 유지비는 출산 <b>문턱</b>을 안 올리지만 <b>도달 속도</b>는 늦춘다. 1.0 에서는 그
         * 지연이 출산에 안 잡혔는데 1.5 에서는 잡혔다 — 무토지 저장고 8.1 이면 2인 가구
         * 출산선 12 에 못 미쳐 바닥 계층이 출산 자격에서 통째로 빠진다. 1.0(무손상)과
         * 1.5(손상) 사이를 잡는다.
         *
